...
describe('Security Factory', () => {
  ...
  it('should work', () => {
    ...
    tree = runner.runSchematic('security', options, tree);
    const files: string[] = tree.files;
    expect(
      files.find(filename => filename === '/src/main.ts'),
    ).toBeDefined();
    expect(
      files.find(filename => filename === '/package.json'),
    ).toBeDefined();
  ...
  it('should manage path', () => {
    ...
    expect(
      files.find(filename => filename === '/foo/package.json'),
    ).toBeDefined();

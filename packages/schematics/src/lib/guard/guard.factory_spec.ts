...
describe('Guard Factory', () => {
  ...
  it('should manage name only and create spec file', () => {
    ...
    expect(
      files.find(filename => filename === '/app/foo.guard.spec.ts'),
    ).toBeDefined();
  ...
  it('should manage name has a path', () => {
    ...
    const files: string[] = tree.files;
    expect(
      files.find(filename => filename === '/app/bar/foo.guard.ts'),
    ).toBeDefined();
  ...
  it('should manage name and path', () => {
    ...
    const files: string[] = tree.files;
    expect(
      files.find(filename => filename === '/baz/src/app/guards/foo.guard.ts'),
    ).toBeDefined();
  ...
  it('should manage name to dasherize', () => {
    ...
    const files: string[] = tree.files;
    expect(
      files.find(filename => filename === '/app/foo-bar.guard.ts'),
    ).toBeDefined();
  ...
  it('should manage path to dasherize', () => {
    ...
    const files: string[] = tree.files;
    expect(
      files.find(filename => filename === '/app/bar-baz/foo.guard.ts'),
    ).not.toBeUndefined();

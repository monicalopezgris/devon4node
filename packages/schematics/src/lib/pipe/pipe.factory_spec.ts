...
describe('Pipe Factory', () => {
  ...
  it('should manage name only', () => {
    ...
    expect(
      files.find(filename => filename === '/app/foo/foo.pipe.ts'),
    ).toBeDefined();
  ...
  it('should manage name as a path', () => {
    ...
    const files: string[] = tree.files;
    expect(
      files.find(filename => filename === '/app/bar/foo/foo.pipe.ts'),
    ).toBeDefined();
  ...
  it('should manage name and path', () => {
    ...
    const files: string[] = tree.files;
    expect(
      files.find(filename => filename === '/baz/src/app/foo/foo.pipe.ts'),
    ).toBeDefined();
  ...
  it('should manage name to dasherize', () => {
    ...
    const files: string[] = tree.files;
    expect(
      files.find(filename => filename === '/app/foo-bar/foo-bar.pipe.ts'),
    ).toBeDefined();
  ...
  it('should manage path to dasherize', () => {
    ...
    const files: string[] = tree.files;
    expect(
      files.find(filename => filename === '/app/bar-baz/foo/foo.pipe.ts'),
    ).toBeDefined();
